Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lotosbin/yuntongxun"
  ...
  # Or just: s.author    = "lotosbin"
  # s.authors            = { "lotosbin" => "lotosbin@gmail.com" }
  # s.social_media_url   = "http://twitter.com/lotosbin"
  ...
  s.source       = { :git => "https://github.com/lotosbin/yuntongxun.git", :tag => "v0.0.1" }
